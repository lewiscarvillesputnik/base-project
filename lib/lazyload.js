function lazyload() {
  ...
  function supportsWebp() {
    ...
    if (!!(elem.getContext && elem.getContext("2d"))) {
      var testString = !(window.mozInnerScreenX == null) ? "png" : "webp"; // was able or not to get WebP representation
  ...
  function imageSize(el) {
    ...
    if (retina) {
      if (desktopScreen) {
        ...
        return retinaTablet != undefined ? retinaTablet + imageFileType(el) : standardTablet != undefined ? standardTablet + imageFileType(el) : standardDesktop + imageFileType(el);
      } else if (tabletAltScreen && (retinaAltTablet != undefined || standardAltTablet != undefined)) {
        return retinaAltTablet != undefined ? retinaAltTablet + imageFileType(el) : standardAltTablet != undefined ? standardAltTablet + imageFileType(el) : standardDesktop + imageFileType(el);
      } else if (mobileScreen && (retinaMobile != undefined || standardMobile != undefined)) {
        return retinaMobile != undefined ? retinaMobile + imageFileType(el) : standardMobile != undefined ? standardMobile + imageFileType(el) : standardDesktop + imageFileType(el);
      } else if (mobileAltScreen && (retinaAltMobile != undefined || standardAltMobile != undefined)) {
        return retinaAltMobile != undefined ? retinaAltMobile + imageFileType(el) : standardAltMobile != undefined ? standardAltMobile + imageFileType(el) : standardDesktop + imageFileType(el);
      } else {
      ...
      if (desktopScreen) {
        ...
        return standardAltTablet != undefined ? standardAltTablet + imageFileType(el) : standardDesktop + imageFileType(el);
        ...
        return standardAltMobile != undefined ? standardAltMobile + imageFileType(el) : standardDesktop + imageFileType(el);
      } else {
        return standardDesktop + imageFileType(el);
      }
    }
